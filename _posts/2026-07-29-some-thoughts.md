...
关于 AI-Native，我觉得如果是以真正 AI-Native 的思维去思考，则应该摒弃掉旧的思维模式，打造围绕 AI 的系统，而非面向人。面向 AI 和面向人，本身就是冲突的。AI 不需要多优雅的界面，多合理的交互，而人需要。AI 对所谓的结构化信息无太多要求，而人需要。如果真要两者兼顾，也应该优先服务好 AI，而不是人。厌倦了各式各样繁琐的管理系统管理页面，如果真正 AI-Native，对人暴露的，只需要一个简单的聊天窗。真正的核心价值，是隐藏在聊天窗之后的，用户看不见的，真正智能化的系统。用户无需和旧时代一样，在不同的系统/不同的页面去关注不同的信息。
